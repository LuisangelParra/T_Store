...
import 'package:t_store/features/personalization/screens/profile/widgets/re_authenticate_user_login_format.dart';
    ...
    try {
      ...
      if (user.value.id.isEmpty) {
        ...
        if (userCredentials != null) {
          ...
          final username =
              UserModel.generateUsername(userCredentials.user!.email ?? '');
    ...
    try {
      ...
      if (image != null) {
        ...
        TLoaders.successSnackBar(
            ...
            message: 'Your Profile Images has been updated!');
      }
    } catch (e) {
      TLoaders.errorSnackBar(
        title: 'Oh Snap!',
